...
plot(training$magnet_arm_z, training$magnet_arm_y, main = "Correlated Variables")
```
...
I used knn because it is relatively quick and is quite intuitive for the given classification (5 classes) that we are attempting. I also used nzv to get rid of any non zero variance variables and I used 10 cross validations. 
...
print(accuracy)
```
Not bad. I dont think we run the risk of overfitting too much, so I believe the real test error will be something like this.
